<section class="white-bg">
    ...
    <div class="relative">
        ...
        {{-- <div class="footer-big-img">
            <img style="width:200px" src="images/logo/clickbuy-aar.png" alt="">
        </div> --}}
        <div style="padding: 0px" class="middle-footer">
            <div class="container">
                    ...
                    <div class="col-lg-8 col-sm-12 mb-40">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-6 mb-20">
                                ...
                                <div class="d-flex flex-column mt-20">
                                    <div>Gọi mua:  <b>085 367 5166</b></div>
                                    <div>Kỹ thuật: <b>085 367 5 166</b></div>
                                </div>
                            </div>
                ...
                <div class="copyright-footer">
                    Copyright &copy; 2023 CLICKBUY. All rights severved.
                </div>
            </div>
        </div>
    </div>
