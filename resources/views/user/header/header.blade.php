...
<div class="head-bg">
    <div class="container-fluid">
        <div class="d-flex align-items-center">
            {{-- Logo --}}
            <div style="width:30%" class="w-7">
                <a style="width:300px" href="{{route('user/index')}}" class='head-brand'>
                    <img style="width:300px" src="images/logo/clickbuy-aar.png" alt="Logo">
                </a>
            </div>
            ...
            <div class="w-93">
                <div class="head-items">
                    <div class="d-flex align-items-center justify-content-lg-between">
                        {{-- điện thoại --}}
                        {{-- <a href="{{route('user/dien-thoai')}}" class='head-item pt-15 pb-15 white'>CLICKBUY</a> --}}
