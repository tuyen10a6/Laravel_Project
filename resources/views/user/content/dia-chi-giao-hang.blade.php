<!DOCTYPE html>
<html lang="en">
    @section("title")Địa chỉ giao hàng | CLICKBUY @stop
    @include("user.header.head")
<body style="background: rgb(240, 217, 217)" class="address-delivery-bg">
    <div style="background: rgb(236, 128, 128)" class="address-delivery-header">
        <div class="container">
            <img style="width:400px" src="images/logo/clickbuy-aar.png" alt="logo" width="80px">
        </div>
    </div>
