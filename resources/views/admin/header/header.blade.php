{{-- logo --}}
<a style="width:350px;background:rgb(229, 125, 125)" href={{route('admin/dashboard')}} class='header-logo' aria-expanded="false">
    <img style="width:350px" src="images/logo/clickbuy-aar.png" alt="">
</a>
{{-- navigation --}}
<div style="background:rgb(229, 125, 125) " class="navigation">
    <!-- logo -->
