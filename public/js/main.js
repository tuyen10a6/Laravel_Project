...
$(function () {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                if (data == "done") {
                                    ...
                                    console.log(
                                        sessionStorage.getItem("loadMoreRow")
                                    );
                                }
                            },
                        });
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status === "another platform") {
                        ...
                        sessionStorage.setItem(
                            "alert-top-message",
                            "Đơn hàng đang được thanh toán trên ứng dụng di động"
                        );
                ...
                success: function (data) {
                    ...
                    $.each(data.phoneList, function (i, val) {
                        ...
                        if (val.modelStatus === false) {
                            infoComponent = `<div class="d-flex flex-column w-75 p-10">
                                        <b>${val.tensp}</b>
                        ...
                        // hàng sắp về
                            ...
                            infoComponent = `<div class="d-flex flex-column w-75 p-10">
                                        ...
                                        <div class="d-flex align-items-center mt-5">
                                            <span class="red fw-600">${numberWithDot(
                                                val.giakhuyenmai
                                            )}<sup>đ</sup></span>
                                            ${
                                                val.khuyenmai != 0
                                                    ? `<span class="text-strike ml-10">${numberWithDot(
                                                          val.gia
                                                      )}<sup>đ</sup></span>
                                                <span class="red ml-10">-${
                                                    val.khuyenmai * 100
                                                }%</span>`
                                                    : ""
                                            }
                        ...
                        phone += `<a href="dienthoai/${
                            val.tensp_url
                        }" class="head-single-result">
                                    <div class="d-flex">
                                        <div class="w-25 p-10">
                                            <img src="${
                                                data.url_phone + val.hinhanh
                                            }" alt="">
                                        </div>
                                        ${infoComponent}
                                    </div>
    ...
    switch (page) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data == "valid") {
                            ...
                            firebase
                                .auth()
                                .signInWithPhoneNumber(telFormat, appVerifier)
                            ...
                            if (!$(".error-message").length) {
                                var message = $(
                                    '<div class="error-message mb-20">Số điện thoại ' +
                                        telInp.val() +
                                        " đã được đăng ký</div>"
                                );
            ...
            function codeVerify(codeInput) {
                ...
                coderesult
                    ...
                    .catch(function (error) {
                        ...
                        codeInput.addClass("required");
                        errMessage;
                        var errMessage = $(
                            '<div class="required-text text-center">Mã xác thực không hợp lệ, vui lòng kiểm tra lại</div>'
                        );
            ...
            // quên mật khẩu
                ...
                $("#forget-step-1").click(function () {
                    ...
                    if (valiTel) {
                        if (!verifier) {
                            var elmnt = $(
                                '<span id="required-recaptcha" class="required-text">Vui lòng xác nhận</span>'
                            );
                            setTimeout(() => {
                                setTimeout(() => {
                                    elmnt.remove();
        ...
        case "dangnhap": {
            ...
            function validateLogin(telInp, pwInp) {
                ...
                if (telInp.val().length == 0) {
                    ...
                    return false;
                } else if (!telInp.val().match(phoneno)) {
                ...
                if (pwInp.val().length == 0) {
                    ...
                    var required = $(
                        '<span class="required-text">Vui lòng nhập mật khẩu</span>'
                    );
        ...
        case "taikhoan": {
            if (
                childPage == "thongbao" &&
                (navigation == "reload" || navigation == "back_forward")
            ) {
                loadMoreFlag = true;
                setTimeout(() => {
                    setTimeout(() => {
            ...
            $("#change-fullname-btn").click(function () {
                var valiFullname = validateFullName(
                    $('input[name="new_fullname_inp"]')
                );
            ...
            $("#change-pw-btn").click(function () {
                ...
                if ($("#old_pw").val().length == 0) {
                    ...
                    var errMess = $(
                        '<div class="required-text">Vui lòng nhập mật khẩu</div>'
                    );
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data["status"] == "invalid password") {
                                $("#old_pw").addClass("required");
                                var errMess = $(
                                    '<div class="required-text">Mật khẩu cũ không chính xác</div>'
                                );
                                $("#old_pw").after(errMess);
                            } else {
                ...
                .click(function () {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            $(`.noti-type[data-type="${type}"]`).addClass(
                                "noti-type-selected"
                            );
            ...
            $(document).on("click", ".noti-btn-read", function () {
                ...
                $.ajax({
                    ...
                    success: function () {
                        $("#noti-" + id)
                            .addClass("account-noti-checked")
                            .removeClass("account-noti-wait");
                        ...
                        success: function () {
                            setTimeout(() => {
                                ...
                                if ($("#lst_favorite").children().length == 0) {
                                    ...
                                    noFavoriteProductElement.appendTo(
                                        $("#lst_favorite")
                                    );
                                }
                            }, 500);
        ...
        case "timkiem": {
            ...
            if (childPage === undefined) {
                ...
                if (params.has("hang")) {
                    ...
                    $(".shop-btn-remove-filter").click(function () {
                        // icon loading
                        var loading = $(
                            '<div class="spinner-border text-light" role="status" style="width: 24px; height: 24px"></div>'
                        );
                        $("#btn-see-filter").text("");
                        ...
                        arrTemp = [];
                        $('div[name="filter-item"]').removeClass(
                            "filter-selected"
                        );
                            ...
                            if ($(this).hasClass("filter-selected")) {
                                switch (type) {
                                    case "brand":
                                        ...
                                        if (
                                            arrFilterSort.filter["brand"]
                                                .length == 0
                                        ) {
                                            delete arrFilterSort.filter[
                                                "brand"
                                            ];
                                        }
                                    ...
                                    case "os":
                                        index =
                                            arrFilterSort.filter["os"].indexOf(
                                                keyword
                                            );
                                        if (index > -1) {
                                            arrFilterSort.filter["os"].splice(
                                                index,
                                                1
                                            );
                                        }
                                        if (
                                            arrFilterSort.filter["os"].length ==
                                            0
                                        ) {
                                    ...
                                    case "ram":
                                        index =
                                            arrFilterSort.filter["ram"].indexOf(
                                                keyword
                                            );
                                        if (index > -1) {
                                            arrFilterSort.filter["ram"].splice(
                                                index,
                                                1
                                            );
                                        }
                    ...
                    function loadFilterSortData(data) {
                        ...
                        if (Object.keys(arrFilterSort.filter).length == 0) {
                            ...
                            $(".filter-badge").text(
                                Object.keys(arrFilterSort.filter).length
                            );
                            $(".filter-badge").css("display", "block");
                        }

                        if (
                            Object.keys(arrFilterSort.filter).length == 0 &&
                            (arrFilterSort.sort == "" ||
                                arrFilterSort.sort === "default")
                        ) {
                            localStorage.removeItem("filterSortJson");
                        } else {
                            localStorage.setItem(
                                "filterSortJson",
                                JSON.stringify(arrFilterSort)
                            );
                        }
                    }
            ...
            =============================================================================*/
                ...
                if (params.has("danhgia")) {
                    ...
                    if (evaluate.length) {
                        const position =
                            parseFloat(evaluate.position().top) + 650;
                ...
                // mẫu sp ngừng kinh doanh
                    ...
                    $("#main-img").after(
                        '<div class="stop-business-badge note-badge"></div>'
                    );
                    $(".favorite-tag").hide();
                ...
                function toggleElementWhenOutOfStock(data) {
                    ...
                    // hàng sắp về
                        ...
                        $("#main-img").after(
                            '<div class="coming-soon note-badge">HÀNG SẮP VỀ</div>'
                        );
                        $(".buy-now").hide();
                        $(".favorite-tag").show();
                        $("#check-qty-in-stock-btn").hide();
                    ...
                    // hết hàng
                        ...
                        $("#main-img").after(
                            '<div class="out-of-stock-badge note-badge"></div>'
                        );
                        $(".buy-now").hide();
                        $(".favorite-tag").show();
                        $("#check-qty-in-stock-btn").hide();
                ...
                $("#check-qty-in-stock-btn").click(function () {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            $("#check-qty-in-stock-phone-name").text(
                                data.tensp
                            );
                            ...
                            $.each(data.mausac, (i, val) => {
                                html += `
                                    <div type="button" data-id="${
                                        val.id
                                    }" class="check-qty-in-stock-item">
                                        <img src="${
                                            urlPhone + val.hinhanh
                                        }" alt="">
                                        <div id="color-name" class="pt-5">${
                                            val.mausac
                                        }</div>
                                    </div>`;
                            });
                ...
                $("#check-qty-in-stock-select").change(function () {
                    const selectedColor = $(
                        ".check-qty-in-stock-item.choose-color-selected"
                    );
                ...
                $("#check-qty-in-stock-modal").on(
                    "hidden.bs.modal",
                    function () {
                        $("#check-qty-in-stock-lst-color").children().remove();
                        $("#check-qty-in-stock-select option:first").prop(
                            "selected",
                            true
                        );
                ...
                function getBranchWithQtyInStock(id_sp, id_tt) {
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data.length === 0) {
                                const noBranch = `<div class="single-branch text-center">Không có chi nhánh còn hàng.</div>`;
                ...
                if ($("#total_rating").length) {
                    ...
                    var total_star_5 =
                        5 * parseInt($("#percent-5-star").data("id"));
                    var total_star_4 =
                        4 * parseInt($("#percent-4-star").data("id"));
                    var total_star_3 =
                        3 * parseInt($("#percent-3-star").data("id"));
                    var total_star_2 =
                        2 * parseInt($("#percent-2-star").data("id"));
                    var total_star_1 =
                        1 * parseInt($("#percent-1-star").data("id"));
                ...
                $("#all_phone_evaluate").click(function () {
                    if ($(this).is(":checked")) {
                        $(".phone-evaluate").addClass(
                            "phone-evaluate-selected"
                        );
                        removeRequried($(".phone-evaluate-div"));
                    } else {
                        $(".phone-evaluate").removeClass(
                            "phone-evaluate-selected"
                        );
                    }
                });
                ...
                $("#choose-phone-evaluate").click(function () {
                    // chưa chọn
                    if (
                        $(".phone-evaluate.phone-evaluate-selected").length == 0
                    ) {
                        if ($(".phone-evaluate-div").hasClass("required")) {
                            return;
                        }
                        $(".phone-evaluate-div").addClass("required");
                        $(".phone-evaluate-div").after(
                            '<span class="required-text">Vui lòng ít nhất 1 sản phẩm</span>'
                        );
                        return;
                    }
                    ...
                    var lst_id = [];
                    $(".phone-evaluate.phone-evaluate-selected").each(
                        function () {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data.length === 1) {
                                ...
                                const phoneChosen = data
                                    .map((val) => {
                                        return `<div class="phone-chosen-item">
                ...
                $("#phone-evaluate-modal").on("shown.bs.modal", function () {
                    ...
                    if (lst_id) {
                        ...
                        $.each(lst_id, function (key, val) {
                            $(`.phone-evaluate[data-id="${val}"]`).addClass(
                                "phone-evaluate-selected"
                            );
                        });
                    }
                ...
                $(".upload-evaluate-image").change(function () {
                    ...
                    $.each(this.files, (i, image) => {
                        ...
                        if (
                            ...
                            if (qty_img >= 3) {
                                showAlertTop(
                                    "Bạn chỉ được phép chọn 3 ảnh đính kèm"
                                );
                                return false;
                            }
                            ...
                            if (size > MAX_SIZE_IMAGE) {
                                showAlertTop(
                                    "Ảnh đính kèm có dung luọng tối đa là 5 MB"
                                );
                                return false;
                            }
                            ...
                            const imageEvaluate = renderEvaluateImage(
                                "create",
                                id,
                                imgURL
                            );
                ...
                async function submitEvaluate() {
                    ...
                    var valiPhoneEvaluate = validatePhoneEvaluate(
                        $("#phone-evaluate-div")
                    );
                    ...
                    if (valiStarRating && valiPhoneEvaluate) {
                        ...
                        if ($(".evaluate-img-div").children().length) {
                            await pushBase64ToArray($(".img-rating img")).then(
                                (base64List) => (evaluateImage = base64List)
                            );
                        }
                ...
                function validateStarRating(starRating) {
                    ...
                    if (starRating.val() == "0") {
                        var required = $(
                            '<span class="star_rating_required required-text">Vui lòng chọn đánh giá</span>'
                        );
                ...
                function validatePhoneEvaluate(phoneEvaluate) {
                    ...
                    if (phoneEvaluate.data("flag") == null) {
                        var required = $(
                            '<span id="choose-phone-evaluate-required" class="required-text">Vui lòng chọn sản phẩm đánh giá</span>'
                        );
                ...
                function seeReviewImage(id_img, id_dg) {
                    ...
                    // ảnh lớn
                    $("#review-image-main").attr(
                        "src",
                        $(`.img-evaluate[data-id="${id_img}"]`).attr("src")
                    );
                    ...
                    $(`img[data-evaluate="${id_dg}"]`).removeClass(
                        "img-evaluate-selected"
                    );
                    $(`img[data-id="${id_img}"]`).addClass(
                        "img-evaluate-selected"
                    );
                ...
                $(".prev-see-review-image").click(function () {
                    var imgSelected = $("#another-review-image").find(
                        $(".img-evaluate.img-evaluate-selected")
                    );
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data["status"] == "like success") {
                                // thay đổi nút
                                $(`.like-comment[data-id="${id_dg}"]`).addClass(
                                    "liked-comment"
                                );
                                $("#like-icon")
                                    .removeClass("fal fa-thumbs-up")
                                    .addClass("fas fa-thumbs-up");

                                // tăng lượt thích
                                var qty = parseInt(
                                    $(
                                        `.qty-like-comment[data-id="${id_dg}"]`
                                    ).text()
                                );
                                $(`.qty-like-comment[data-id="${id_dg}"]`).text(
                                    ++qty
                                );
                            }
                            // bỏ thích
                                ...
                                // thay đổi nút
                                $(
                                    `.like-comment[data-id="${id_dg}"]`
                                ).removeClass("liked-comment");
                                $("#like-icon")
                                    .removeClass("fas fa-thumbs-up")
                                    .addClass("fal fa-thumbs-up");
                ...
                $(document).on("click", ".send-reply", function () {
                    ...
                    if (replyContent.val().length == 0) {
                        ...
                        replyContent.after(
                            '<span class="required-text">Vui lòng nhập câu trả lời</span>'
                        );
                        return;
                    }
                ...
                $(".edit-evaluate")
                    ...
                    .click(function () {
                        ...
                        for (var i = 1; i <= star; i++) {
                            $(`.edit-star-rating[data-id="${i}"]`).css(
                                "color",
                                "orange"
                            );
                        }
                        ...
                        // số lượng hình
                        $(".edit-qty-img-inp").val(
                            $(`img[data-evaluate="${id_dg}"]`).length
                        );
                        $(".edit-qty-img").show();
                        ...
                        $(`img[data-evaluate="${id_dg}"]`).each(function (i) {
                            ...
                            // hình đánh giá
                            var imageEvaluate = renderEvaluateImage(
                                "edit",
                                i,
                                src
                            );
                ...
                function renderEvaluateImage(type, id, src) {
                    ...
                    if (type === "create") {
                        element = `<div id="img-rating-${id}" class="img-rating">
                        ...
                        element = `<div id="edit-img-rating-${id}" class="img-rating">
                                <div class="img-rating-overlay"></div>
        ...
        case "giohang": {
            ...
            if (totalItem === totalChecked) {
                $('.cart-header [data-id="all"]').addClass(
            ...
            async function makePayments() {
                ...
                if (isCheck) {
                    getProductIdListToCheckout().then((response) => {
                        ...
                        if (newCheckoutList.length === 0) {
                            showToast(
                                "Bạn không thể thanh toán sản phẩm đã hết hàng"
                            );
                            return;
                        }
                        ...
                        switch (data.status) {
                            ...
                            case "waiting":
                                ...
                                removeQueue(id_tk)
                                    .then(() =>
                                        showAlertTop(
                                            "Sản phẩm đang được thanh toán bởi người dùng khác, xin vui lòng chờ đến lượt"
                                        )
                                    )
                                    .catch(() => showAlertTop(errorMessage));
                                break;
                            case "out of stock":
                                removeQueue(id_tk).then(() => {
                                    const message =
                                        "Oops! Có sản phẩm đã hết hàng, bạn không thể thanh toán đơn hàng này.";
                                    sessionStorage.setItem(
                                        "alert-top-message",
                                        message
                                    );
                            ...
                            case "not enough quantity":
                                removeQueue(id_tk).then(() => {
                                    ...
                                    const message = `Số lượng tồn kho không đủ để thanh toán:
                                        <ul>${productList}</ul>`;
                            ...
                            case "have been paid":
                                const message =
                                    "Sản phẩm bạn chọn đã được thanh toán trên ứng dụng di động";
                                sessionStorage.setItem(
                                    "alert-top-message",
                                    message
                                );
        ...
        case "thanhtoan": {
            ...
            $('input[name="branch"]').change(function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $.each(productList, (i, val) => {
                            if (val.trangthai === "out of stock") {
                                outOfStock += `<div class="d-flex red pb-10 fz-14">
                                ...
                                qtyIsNotEnough += `<div class="d-flex red pb-10 fz-14">
                                        <img src="images/phone/${val.hinhanh}" width="80px">
                                        <div class="ml-5">
                                            <div>${val.tensp}</div>
                                            <div>Màu sắc: ${val.mausac}</div>
                                ...
                                inStocks += `<div class="d-flex pb-10 fz-14">
                                        <img src="images/phone/${val.hinhanh}" width="80px">
                                        <div class="ml-5">
                                            <div>${val.tensp}</div>
                                            <div>Màu sắc: ${val.mausac}</div>
                    ...
                    error: function () {
                        showToast(
                            "Đã có lỗi xảy ra khi lấy dữ liệu, Vui lòng làm mới lại trang"
                        );
                    },
                });
            });
            ...
            async function confirmCheckout() {
                ...
                if (isCheck) {
                    // hình thức nhận hàng
                    var receciveMethod = $(
                        'input[name="receive-method"]:checked'
                    ).val();
                    ...
                    if (receciveMethod === "Giao hàng tận nơi") {
                        ...
                        if ($(".atHome").data("flag") == 0) {
                            ...
                            var required = $(
                                '<span class="required-text">Bạn chưa có địa chỉ giao hàng</span>'
                            );
                    ...
                    // nhận tại cửa hàng
                        ...
                        if (!$('input[name="branch"]:checked').val()) {
                            ...
                            if (!$(".list-branch").hasClass("required")) {
                                ...
                                const requiredText = `<span class="required-text">Vui lòng chọn chi nhánh</span>`;
                        ...
                        if (
                            $(".info-qty-in-stock").attr("is-checkout") ===
                            "false"
                        ) {
                            $(window).scrollTop(0);
                            showAlertTop(
                                "Bạn không thể thanh toán khi có sản phẩm đã hết hàng hoặc số lượng không đủ để thanh toán."
                            );
                            return;
                        }
                ...
                if (data == "") {
                    ...
                    timer = setTimeout(() => {
                        ...
                        $.ajax({
                            ...
                            data: { str: val },
                            success: function (data) {
                                $(".compare-list-search-phone")
                                    .children()
                                    .remove();
                                if (data.phoneList.length === 0) {
                                    $(".compare-list-search-phone").hide(
                                        "blind"
                                    );
                                    return;
                                }
                                ...
                                $.each(data.phoneList, function (key, val) {
                                    ...
                                    // hàng sắp về
                                        ...
                                        infoComponent = `<div class="d-flex">
                                                <b>${val.tensp}</b>
                                    ...
                                    phone += `<div type="button" data-name="${
                                        val.tensp_url
                                    }" class="head-single-result">
                                            <div class="d-flex">
                                                <div class="w-25 p-10">
            ...
            $(".delete-compare-btn")
                ...
                .click(function () {
                    ...
                    // xóa đt theo order ở url
                        ...
                        location.href =
                            "sosanh/" + lst_urlName[0] + "vs" + lst_urlName[1];
                    }
                });
        ...
        case "tracuu": {
            ...
            $("#btn-check-imei").click(function () {
                ...
                if (IMEI.length === 0) {
                    required = $(
                        '<div class="required-text text-center">Số IMEI không được bỏ trống</div>'
                    );
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.status === "invalid imei") {
                            required = $(
                                '<div class="required-text text-center">Số IMEI không hợp lệ</div>'
                            );
                            $("#imei-inp").addClass("required");
                            $("#imei-inp").after(required);
                        }
                        // hợp lệ
                            ...
                            // trạng thái bảo hành
                            var warrantyStatusText = data.product
                                .trangthaibaohanh
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-6 col-12 mb-40">
                                                        <img src="images/phone/${
                                                            product.hinhanh
                                                        }" alt="" class="w-80 center-img">
                                                        <div class="d-flex flex-column justify-content-center align-items-center">
                                                            <div class="fz-26 fw-600 pt-20 pb-20">${
                                                                product.tensp
                                                            }</div>
    ...
    function showIOSScreen() {
        var screen = `<div class="ios-screen">
    ...
    function getBackToTheOldPosition() {
        ...
        if (localStorage.getItem("filterSortJson")) {
            ...
            setTimeout(() => {
                ...
                let filterSortJson = JSON.parse(
                    localStorage.getItem("filterSortJson")
                );
                localStorage.removeItem("filterSortJson");
                    ...
                    success: function (data) {
                        ...
                        $.each(arrFilterSort.filter, function (type, arr) {
                            $.each(arr, function (i, data) {
                                $(
                                    `[data-type="${type}"][data-keyword="${data}"]`
                        ...
                        if (arrFilterSort.sort != "") {
                            $(
                                `[name="sort"][value="${arrFilterSort.sort}"]`
                            ).prop("checked", true);
                        }
                        arrTemp = [];
            ...
            const position = sessionStorage.getItem("scrollPosition")
                ...
                : 0;
            loadMoreRow = sessionStorage.getItem("loadMoreRow")
                ? parseInt(sessionStorage.getItem("loadMoreRow"))
                : 0;
    ...
    function editAddressModal(id, defaultAdr = false) {
        ...
        getUserAddress(id)
                ...
                Promise.all([
                    ...
                    .then((data) => {
                        ...
                        Promise.all([
                            ...
                            .then((data) => {
                                $("#PhuongXa-selected").removeClass(
                                    "select-disable"
                                );
                                $("#PhuongXa-selected").addClass(
                                    "select-selected"
                                );
                            })
                            .catch(() => {
                                sessionStorage.setItem(
                                    "toast-message",
                                    "Không thể lấy danh sách dữ liệu. Vui lòng thử lại"
                                );
                                location.reload();
                            });
                    })
            ...
            .catch(() => {
                $(".loader").fadeOut();
                showAlertTop(
                    "Không thể lấy dữ liệu. Vui lòng làm mới lại trang"
                );
            });
    }
    ...
    function choosePlace(id, name, type) {
        if (type === "TinhThanh") {
            ...
            // spinner
            $("#QuanHuyen-selected i").replaceWith(
            ...
            getDistrict(id)
                .then(() => {
                    ...
                    $("#QuanHuyen-selected .select-spinner").replaceWith(
            ...
            $("#PhuongXa-selected i").replaceWith(
                '<div class="spinner-border select-spinner" role="status"></div>'
            );
            ...
            getWard(id)
                .then(() => {
                    ...
                    $("#PhuongXa-selected .select-spinner").replaceWith(
                        '<i class="far fa-chevron-down fz-14"></i>'
                    );
                ...
                switch (object) {
                    ...
                    case "item-cart":
                        ...
                        if (!$("#lst-cart-item").children().length) {
                            ...
                            const emptyCartElement = `<div class="col-lg-12">
    ...
    function validatePassword(passwordInp, rePasswordInp) {
        ...
        if (
            passwordInp.hasClass("required") ||
            rePasswordInp.hasClass("required")
        ) {
            return;
        }
        ...
        if (pw.length < 6 || pw.length > 16) {
            passwordInp.addClass("required");
            var errMess = $(
                '<div class="required-text">Độ dài mật khẩu từ 6-16 ký tự</div>'
            );
            passwordInp.after(errMess);
            return false;
        }
        ...
        if (rePw == "") {
            ...
            var errMess = $(
                '<div class="required-text">Vui lòng nhập lại mật khẩu</div>'
            );
        ...
        if (pw.localeCompare(rePw) != 0) {
            rePasswordInp.addClass("required");
            var errMess = $(
                '<div class="required-text">Nhập lại mật khẩu không trùng khớp</div>'
            );
            rePasswordInp.after(errMess);
            return false;
        }
    ...
    function showToastRealtime(notificationObject) {
        ...
        if (notificationObject.type === "order") {
            switch (notificationObject.orderStatus) {
                // xác nhận đơn hàng
                case "confirmed":
                    toast = `<div id="alert-toast" class="alert-toast-2">
                    ...
                    toast = `<div id="alert-toast" class="alert-toast-2">
                            ...
                            <div class="alert-toast-2-content">
                                <div class="mb-10" ${style}>
                                    Đơn hàng <b>#${notificationObject.id_dh}</b> đã được giao thành công. Cảm ơn bạn đã mua hàng tại CLICKBUY, chúng tôi xin gửi tặng bạn mã giảm giá... <a href="taikhoan/thongbao">Chi tiết</a>
                                </div>
                                <div class="d-flex justify-content-end align-items-center mr-5">
                                    <div class="dot-green mr-5"></div>
                                    <div class="fst-italic fw-lighter fz-12">Bây giờ</div>
    ...
    function validateDistrict_Wards(district, ward) {
        ...
        // nếu kiểm tra rồi thì return
        if (
            districtParent.hasClass("required") ||
            wardParent.hasClass("required")
        ) {
            return;
        }
    ...
    function chooseColor(id_sp) {
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#choose-color-promotion-price").html(
                    numberWithDot(data.giakhuyenmai) + "đ".sup()
                );
                if (data.khuyenmai != 0) {
                    $("#choose-color-price").html(
                        numberWithDot(data["gia"]) + "đ".sup()
                    );
                }
    ...
    async function voucherCheck() {
        ...
        if (isApplied) {
            if (page === "giohang") {
                bool = await isExpiredVoucher().then((isExpired) => {
                    if (isExpired) {
                        sessionStorage.setItem(
                            "alert-top-message",
                ...
                const isSatisfied = await isSatisfiedVoucher().then(
                    (boolean) => {
                        // không thỏa điều kiện
                        if (!boolean) {
                            return removeVoucher().then(() => {
                                sessionStorage.setItem(
                                    "alert-top-message",
                ...
                // kiểm tra tiếp hết HSD
                    ...
                    bool = await isExpiredVoucher().then((boolean) => {
                        // hết HSD
                        if (boolean) {
                            sessionStorage.setItem(
                                "alert-top-message",
    ...
    function renderPhoneCard(data) {
        ...
        $.each(data, function (i, val) {
            ...
            promotionBadge = "";
            if (val.khuyenmai != 0) {
                promotionBadge = `<div class="shop-promotion-tag">
                    <span class="shop-promotion-text">-${
                        val.khuyenmai * 100
                    }%</span>
                </div>`;
            }
            ...
            if (val.comingSoon) {
                html += `<div class="col-lg-3 col-md-4 col-sm-6 col-6">
                        <a href="dienthoai/${
                            val.tensp_url
                        }" class="shop-product-card-coming-soon">
                            ${promotionBadge}
                            ...
                            <div class="text-center">
                                <div class="mb-5">
                                    <span class="fw-600 red">${numberWithDot(
                                        val.giakhuyenmai
                                    )}<sup>đ</sup></span>
                                    ${
                                        val.khuyenmai != 0
                                            ? `<span class="ml-5 text-strike">${numberWithDot(
                                                  val.gia
                                              )}<sup>đ</sup></span>`
                                            : ""
                                    }
                ...
                html += `<div class="col-lg-3 col-md-4 col-sm-6 col-6">
                        <div class="shop-product-card box-shadow">
                            ...
                            <div type="button" data-id="${
                                val.id
                            }" class="shop-cart-link"><i class="fas fa-cart-plus mr-10"></i>Thêm vào giỏ hàng</div>
                            <a href="dienthoai/${
                                val.tensp_url
                            }" class="shop-detail-link"><i class="far fa-search-plus mr-10"></i>Xem chi tiết</a>
    ...
    function renderNotification(data) {
        ...
        $.each(data, (i, val) => {
            html += `
                <div id="noti-${val.id}" class="single-noti ${
                val.trangthaithongbao == 0
                    ? "account-noti-wait"
                    : "account-noti-checked"
            } box-shadow mb-20">
            ...
            html += `
                        ...
                        <div class="d-flex align-items-end">
                            ...
                            <div type="button" class="noti-btn-delete red" data-id="${
                                val.id
                            }">xóa</div>
                        </div>
                    </div>
    ...
    function updateQtyCart(id, type) {
        $.ajax({
            ...
            success: function (data) {
                ...
                $(`.provisional_item[data-id="${id}"]`).html(
                    numberWithDot(data.newPrice) + "đ".sup()
                );
    ...
    function renderVoucher(data) {
                   ...
                   <div class="col-lg-8 col-md-10 col-12 mx-auto pb-30">
                        <div class="account-voucher">
                            <div class="voucher-left w-20 p-70">
                                ...
                                <div class="voucher-left-content fz-40">-${
                                    val.chietkhau * 100
                                }%</div>
                            </div>
                            <div class="voucher-right w-80">
                                <div class="voucher-right-content">
                                    <div class="d-flex justify-content-end">
                                        <div data-id="${
                                            val.id
                                        }" class="relative promotion-info-icon">
                                                            ...
                                                            <td colspan="2" class="w-40">
                                                                <div class="d-flex flex-column">
                                                                    ...
                                                                    ${
                                                                        ...
                                                                        0
                                                                            ? `<ul class="mt-10">
                                                                        <li>Áp dụng cho đơn hàng từ ${numberWithDot(
                                                                            val.dieukien
                                                                        )}<sup>đ</sup></li>
                                                                    </ul>`
                                                                            : ""
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <span class="d-flex align-items-end">HSD: ${
                                            val.ngayketthuc
                                        }</span>
                                        <div data-id="${
                                            val.id
                                        }" class="apply-voucher-btn main-btn p-10">Áp dụng</div>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        const unsatisfied = data
            .map((val, i) => {
                if (val.status === "unsatisfied") {
                    return `<div class="col-lg-8 col-md-10 col-12 mx-auto pb-30">
                        <div class="account-voucher">
                            <div class="dis-voucher-left w-20 p-70">
                                ${
                                    ...
                                    <div class="dis-voucher-left-content fz-40">-${
                                        val.chietkhau * 100
                                    }%</div>
                            </div>
                            <div class="dis-voucher-right w-80">
                                <div class="voucher-right-content">
                                    <div class="d-flex justify-content-end">
                                        <div data-id="${
                                            val.id
                                        }" class="relative dis-promotion-info-icon">
                                            <i class="fal fa-info-circle fz-20"></i>
                                            <div data-id="${
                                                val.id
                                            }" class="voucher-content">
    ...
    function renderSmallVoucher(voucher) {
        const voucherElement = `<div class='account-voucher'>
                <div class='voucher-left-small'>
                    <div class='voucher-left-small-content'>-${
                        voucher.chietkhau * 100
                    }%</div>
                </div>
                <div class='voucher-right-small'>
                    ...
                    <div class="d-flex align-items-center">
                        <div data-id="${
                            voucher.id
                        }" class="relative promotion-info-icon mr-10">
                        ...
                        <div data-id="${
                            voucher.id
                        }" class="apply-voucher-btn main-btn" style="padding: 5px">Bỏ chọn</div>
                    </div>
                </div>
            </div>`;
    ...
    async function renderCart(data) {
        ...
        let voucherElement = `<tr id="cart-voucher">
                <td>
                    <div class="p-10">
        ...
        if (isVoucher) {
            voucherElement = `<tr id="cart-voucher">
                    <td class="p-0 d-flex">
            ...
            productListElement += `<tr>
                    <td>
                        <div class='d-flex flex-row align-items-center justify-content-between'>
                            ...
                            <b class='d-flex align-items-center justify-content-end red'>${numberWithDot(
                                val.thanhtien
                            )}<sup>đ</sup></b>
                        </div>
                    </td>
                        ...
                        <td>
                            <div class='p-10 d-flex flex-column'>
                                <div id="provisional-text" class='d-flex justify-content-between'>
                                    <span id="provisional" data-provisional="${
                                        data.total
                                    }">Tạm tính (${qty} sản phẩm):</span>
                                    <div>${numberWithDot(
                                        data.total
                                    )}<sup>đ</sup></div>
                                </div>
                    ...
                    <tr>
                        <td>
                            <div class='d-flex align-items-center justify-content-between p-10'>
                                <b>Tổng tiền:</b>
                                <b id="total" data-total="${total}" class='red fz-22'>${numberWithDot(
            total
        )}</b>
                            </div>
                        </td>
            ...
            xhrProvince = $.ajax({
                ...
                success: function (provinceList) {
                    ...
                    const list = provinceList
                        .map((val) => {
                            return `<div id="${val.code}" data-type='TinhThanh' data-name="${val.name}" class="option-tinhthanh select-single-option">${val.name}</div>`;
                        })
                        .join("");

                    $("#list-tinh-thanh").append(list);

                    $("#TinhThanh-selected .select-spinner").replaceWith(
                        '<i class="far fa-chevron-down fz-14"></i>'
                    );
            ...
            xhrDistrict = $.ajax({
                ...
                success: function (data) {
                    ...
                    const list = districtList
                        .map((val) => {
                            if (val.name !== "Chưa rõ") {
                                return `<div id='${val.code}' data-type='QuanHuyen' data-name="${val.name}" class="option-quanhuyen select-single-option">${val.name}</div>`;
                            }
                        })
                        .join("");
        ...
        return new Promise((resolve, reject) => {
            xhrWard = $.ajax({
                ...
                success: function (data) {
                    ...
                    const list = wardList
                        .map((val) => {
                            return `<div id="${val.code}" data-type="PhuongXa" data-name="${val.name}" class="option-phuongxa select-single-option">
                                ${val.name}
                            </div>`;
                        })
                        .join("");
    ...
    $(".address-action-btn")
        ...
        .click(function () {
            ...
            var valiFullname = validateFullName(
                $('input[name="adr_fullname_inp"]')
            );
            var valiTel = validatePhoneNumber($('input[name="adr_tel_inp"]'));
            var valiQuanHuyenPhuongXa = validateDistrict_Wards(
                $("#QuanHuyen-name"),
                $("#PhuongXa-name")
            );
            var valiAddressInp = validateAddressInput(
                $('input[name="address_inp"]')
            );
    ...
    $("#address-modal").on("hidden.bs.modal", function () {
        ...
        $("#TinhThanh-selected i").replaceWith(
            '<div class="spinner-border select-spinner" role="status"></div>'
        );
        $("#QuanHuyen-selected i").replaceWith(
            '<div class="spinner-border select-spinner" role="status"></div>'
    ...
    $("#btn-add-cart").click(function () {
        ...
        if (!id_sp) {
            ...
            var required = $(
                '<span class="required-text">Vui lòng chọn 1 màu sắc</span>'
            );
    ...
    $(document).on("click", "#choose-voucher-button", function () {
        ...
        getProvisionalOrder(idList)
            ...
            .then((data) => {
                let html = `<div class="text-center pt-50 pb-50 fw-600">
            ...
            .catch(() =>
                showToast(
                    "Không thể tải mã giảm giá, vui lòng làm mới lại trang"
                )
            );
    });
            ...
            .then((response) => {
                ...
                if (response.status === "success") {
                    ...
                    if (page === "giohang") {
                        ...
                        voucherElement = `<td class="p-0 d-flex">
                                <div class='w-30 p-10 bg-gray-4 d-flex justify-content-center align-items-center'>
                                    <b>Mã giảm giá</b>
                                </div>
                                <div class="w-70 p-10 d-flex justify-content-center">
                    ...
                    const voucherDiscountText = `<div id="voucher-discount-text" class="d-flex justify-content-between mt-20">
                            <div>Mã giảm giá</div>
                            <div id="voucher" class="main-color-text">-${
                                response.voucher.chietkhau * 100
                            }%</div>
                        </div>`;
                    ...
                    if (page === "giohang") {
                        chooseVoucherBtn = `<span id="choose-voucher-button" class="pointer-cs main-color-text">
                            <i class="fas fa-ticket-alt mr-10"></i>Chọn Mã khuyến mãi
                        </span>`;
                    } else if (page === "thanhtoan") {
                        chooseVoucherBtn = `<td>
                ...
                if (page === "giohang") {
                    ...
                    if (response.status === "success") {
                        ...
                        if (!$("#total").attr("data-new-total")) {
                            const total =
                                $("#provisional").attr("data-provisional");
